...
const technologies = [
  {
    name: "TensorFlow",
    description: "Machine learning framework for skin analysis algorithms",
    icon: (
  ...
  {
    name: "Kubernetes",
    description: "Orchestration platform for scaling services",
    icon: (
    ...
    <section id="technology" className="section-padding bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            Powered by <span className="text-primary-600">Cutting-Edge</span> Technology
          </motion.h2>
          <motion.p 
          ...
          >
            Our platform leverages the latest advancements in AI and cloud computing to deliver exceptional skincare analysis
          </motion.p>
        </div>
